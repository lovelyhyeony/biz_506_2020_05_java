...
public class VarBoolean_04 {
	...
	public static void main(String[] args) {
		 ...
		 * 키워드 변수 = 값 형식으로 선언과 초기화를 할 수 있다.
		 * 
		 * 
		 */
		String str1 = "대한민국"; // 문자열형 변수 대한민국이라는 문자열을 선언하라라는 키워드
		 ...
		 * 
		 * 키워드 변수 = new 키워드() <-()Method ;
		 * 이것은 java의 문법구조 이므로 형식 그대로 이해하자.
		 */
		 ...
		 * 이 명령문은 0부터 99까지의 임의의 정수를 만들어
		 * num1 변수에 저장한다.
		 */
		num1 = rnd.nextInt(100); //0부터 (숫자)-1까지
