 ...
 * 이때 사용하는 클래스들을 Value Object라고 한다. //VO라는 접미사를 붙임
 * 
 *  DTO(Data Transfer Object) 클래스라고도 한다. // 쫌다른 용도로 쓰일때도 있지만 VO==DTO 라고 생각하먼 댐
 *  
 *  주 용도가 변수사용 목적 // VO,DTO 변수 묶음이구나 //Service : 메서드 
 * 
 */
public class scoreVO {

	// 모든 필드(멤버, 속성) 변수를 private으로 선언
	private String num ;
	private String name ;
